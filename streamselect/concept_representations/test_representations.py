...
def test_error_rate_representation_concept() -> None:
    ...
    np.testing.assert_almost_equal(
        ...
        [
            0.0,
            1 / 1,
            np.mean(rep_5_vals[1:3]),
            np.mean(rep_5_vals[1:4]),
            np.mean(rep_5_vals[1:5]),
            np.mean(rep_5_vals[1:6]),
            np.mean(rep_5_vals[1:7]),
            np.mean(rep_5_vals[1:8]),
            np.mean(rep_5_vals[1:9]),
        ],
    )
...
def test_error_rate_representation_update_period() -> None:
    ...
    np.testing.assert_almost_equal(
        ...
        [
            ...
            0.0,
            0.0,
            np.mean([rep_5_vals[3]]),
            np.mean([rep_5_vals[3]]),
            np.mean([rep_5_vals[3]]),
            np.mean([rep_5_vals[3], rep_5_vals[6]]),
            np.mean([rep_5_vals[3], rep_5_vals[6]]),
            np.mean([rep_5_vals[3], rep_5_vals[6]]),
        ],
    )
